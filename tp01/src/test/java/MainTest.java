...
public class MainTest {
    ...
    void testCalculoIMCComMockStatic() {
        try (MockedStatic<Main> mockedMain = mockStatic(Main.class)) {
            mockedMain
                    .when(() -> Main.calcularPeso(80, 1.80))
                    .thenReturn(24.69);
            double imc = Main.calcularPeso(80, 1.80);
            assertThat(imc).isEqualTo(24.69);
            mockedMain.verify(() -> Main.calcularPeso(80, 1.80));
        }
    }
    ...
    void calcularPeso_valoresValidos() {
        ...
        double resultado = Main.calcularPeso(peso, altura);
    ...
    void calcularPeso_pesoNegativo_deveLancarExcecao() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> Main.calcularPeso(peso, altura), MSM_ERRO_PESO);
    }
    ...
    void calcularPeso_alturaAbaixoDoLimite_deveLancarExcecao() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> Main.calcularPeso(peso, altura), MSM_ERRO_ALTURA);
    }
